...
from messaging.frontend import (message_no_duplicates_to_remove)
...
def remove_duplicate_movies_that_are_not_from_staging(possible_duplicate_movie, var1, var2):
...
def removing_duplicate_movies_from_staging(possible_duplicate_movie,
	...
	if f"/{var1}/" in possible_duplicate_movie[0] and f"/{var2}/" not in possible_duplicate_movie[1]:
		...
		messaging.message_no_duplicates_to_remove()
